...
![](https://docs.oracle.com/cd/B28359_01/datamine.111/b28129/img/scatter_plot.gif)
...
> ? don't some use $\frac{1}{N-2}$ instead of $\frac{1}{N}$. What is the difference? I'll have to ask someone later.

$$\text{RSE} = \displaystyle \sqrt{\frac{1}{n - 2}\cdot \text{RSS}} \ = \displaystyle \sqrt{\frac{1}{n - 2} \displaystyle \sum_{i = 1}^n (y_i - \hat{y}_i)^2}$$
